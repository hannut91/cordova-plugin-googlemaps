cordova.define("cordova-plugin-googlemaps.HtmlInfoWindow", function(require, exports, module) {
  ...
  var HTMLInfoWindow = function() {
      ...
      anchorDiv.style.setProperty("transition", "transform 500ms");
      anchorDiv.style.setProperty("-webkit-transition", "transform 500ms");
  ...
  */
      ...
      var calculate = function() {
        ...
        if (typeof icon === "object") {
          ...
          if (typeof icon.anchor === 'object') {
            anchor.x = icon.anchor.x;
            anchor.y = icon.anchor.y;
          }
        }
      ...
      self.on("infoPosition_changed", function(ignore, point) {
        ...
        //     anchorDiv.style.setProperty("-webkit-transform", "translate(" + x + "px, " + y + "px)");
        //     anchorDiv.style.setProperty("transform", "translate(" + x + "px, " + y + "px)");
